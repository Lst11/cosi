...
public class Fourier {
    ...
    public static ArrayList<Complex> discreteFourier(ArrayList<Complex> a, int N, int dir, Counter mul, Counter add) {
    ...
    public static ArrayList<Complex> fastFourier(ArrayList<Complex> a, int N, int dir, Counter mul, Counter add) {
        if (a.size() == 1) {
            return a;
        }
        ...
        b = fastFourier(even, even.size(), dir, mul, add);
        c = fastFourier(odd, odd.size(), dir, mul, add);
